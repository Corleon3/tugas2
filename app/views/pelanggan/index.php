<div style="max-width:800px; margin:10px auto;">
     ...
     <div class="card" style="color:black; background-color: 	#00FF7F; margin:20px;">
          <h5 class="card-header" style="background-color:#FF6347; font-weight:bold;">Table Album</h5>
          <div class="card-body">
               <table class="table table-hover" style="background-color: #D2B48C;">
                    <thead>
                         <tr>
                              <th scope="col">Id</th>
