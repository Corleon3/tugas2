<div style="max-width:800px; margin:10px auto;">
     ...
     <div class="card" style="color:black; background-color: #F08080; margin:20px;">
          <h5 class="card-header" style="background-color:#4169E1; font-weight:bold;">Table Album</h5>
          <div class="card-body">
               <table class="table table-hover" style="background-color: 	#008080;">
                    <thead>
                         <tr>
                              <th scope="col">Id</th>
