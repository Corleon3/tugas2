<div style="max-width:800px; margin:10px auto;">
     ...
     <!-- button tambah  -->
     <button style="margin: 20px 0;" type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#tambahData">
          Tambah Golongan
     </button>
     ...
     <div class="card" style="color:black; background-color: 	#1E90FF; margin:20px;">
          <h5 class="card-header" style="background-color:#228B22; font-weight:bold;">Table Album</h5>
          <div class="card-body">
               <table class="table table-hover" style="background-color: 	#FF69B4;">
                    <thead>
                         <tr>
                              <th scope="col">Id</th>
                    ...
                    <tbody>
                         ...
                         ?>
                              <tr>
                                   ...
                                   <td>
                                        <!-- button ubah  -->
                                        <a href="<?php echo BASEURL; ?>/golongan/ubah/<?php echo $golongan["gol_id"]; ?>" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#ubahData<?php echo $golongan["gol_id"]; ?>">Ubah</a>
